...
//        [HttpPut("{id}")]
//        public async Task<IActionResult> PutRoasting(int id, Roasting roasting) //Roasting => RoastingDto
//        {
...
//        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
//        [HttpPost]
//        public async Task<ActionResult<Roasting>> PostRoasting(Roasting roasting) // Roasting => RoastingDto
//        {
//           //var roasting = DTOToRoasting(roastingDTO);
